...
{
    public partial class FormDeleteWarning : FormBase
    {
        private readonly GridView _view = null;

        public FormDeleteWarning()
        {
            InitializeComponent();
        }

        public FormDeleteWarning(GridView view)
        {
            InitializeComponent();
        ...
        {
            ArrayList dataSource = this.gridControl1.DataSource as ArrayList;
            if (dataSource == null)
                return;
